...
export function MonthlyTab({
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: 'MASA SATIŞ',
        data: [monthlyData.find(item => item.reportValue1 === "Masa Satış")?.reportValue3 || 0],
      ...
      {
        label: 'KASA SATIŞ',
        data: [monthlyData.find(item => item.reportValue1 === "Kasa Satış")?.reportValue3 || 0],
      ...
      {
        label: 'PAKET SERVİS',
        data: [monthlyData.find(item => item.reportValue1 === "Paket Servis")?.reportValue3 || 0],
      ...
      {
        label: 'TEZGAH SATIŞ',
        data: [monthlyData.find(item => item.reportValue1 === "Tezgah Satış")?.reportValue3 || 0],
